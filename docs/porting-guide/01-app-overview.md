...
├─────────────────────────────────────────────────────────────────────────┤
│  Toolbar (Camera View, Home, XY/YZ/XZ Plane, Fit Range, ...)           │
│  Time Animation Toolbar (|◀ ◀| ◀ ▶ |▶ ▶| ⟳ | Time: [...] | max is X)     │
├──────────────┬────────────────────────────────────────────┬─────────────┤
│              │                                            │             │
│ Pipeline     │           Center Panel                     │             │
│ Browser      │         (TabbedViewWidget)                 │             │
│ ┌──────────┐ │                                            │             │
│ │☑ Cone    │ │  ┌──────┐ ┌──────┐ ┌──────┐          [+]  │             │
│ │  Source  │ │  │3D View│ │Table │ │Graph │               │             │
│ └──────────┘ │  └──────┘ └──────┘ └──────┘               │             │
│              │  ┌────────────────────────────────────────┐│             │
├──────────────┤  │                                        ││             │
│┌────────────┐│  │                                        ││             │
││Properties│Info││         Active Tab View                ││             │
│├────────────┤│  │           (VTK/Table/Graph)            ││ ┌─────────┐│
││[Apply]     ││  │                                        ││ │ [Send]  ││
││[Delete]    ││  │                                        ││ │ [Cancel]││
││            ││  │                                        ││ │ [New]   ││
